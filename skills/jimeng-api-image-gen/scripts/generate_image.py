...
class JimengImageGenerator:
    ...
    def __init__(
        ...
        self.access_key = access_key or os.environ.get("VOLC_ACCESSKEY") or default_access_key
        self.secret_key = secret_key or os.environ.get("VOLC_SECRETKEY") or default_secret_key
